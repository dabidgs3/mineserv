...
class ServerCore : public Manager {
 public:
  ...
  struct Options {
    ...
    // In a training handler, this option specifies how to serialize tensors
    // (e.g: as proto fields or as proto content).
    // Serialize as proto fields by default, for backward compatibility.
    internal::TrainResponseTensorSerializationOption
            train_response_tensor_serialization_option =
  ...
  predict_response_tensor_serialization_option() const {
    ...
    internal::TrainResponseTensorSerializationOption
    train_response_tensor_serialization_option() const {
        return options_.train_response_tensor_serialization_option;
    }
