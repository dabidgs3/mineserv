...
//
//   POST /v1/models/<model_name>:(classify|regress|predict|train)
//   POST /v1/models/<model_name>/versions/<ver>:(classify|regress|predict|train)
//
// o Model status
//
...
class HttpRestApiHandler {
 ...
 private:
  ...
  Status ProcessPredictRequest(const absl::string_view model_name,
                               ...
                               const absl::string_view request_body,
                               string* output);
  Status ProcessTrainRequest(const absl::string_view model_name,
                               const absl::optional<int64>& model_version,
                               const absl::string_view request_body,
                               string* output);
  ...
  std::unique_ptr<TensorflowTrainer> trainer_;
